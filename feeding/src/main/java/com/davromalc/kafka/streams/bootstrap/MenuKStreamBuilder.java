...
import com.davromalc.kafka.streams.mail.MailBuilder;
import com.davromalc.kafka.streams.model.Menu;
import com.davromalc.kafka.streams.reducer.FoodReducer;
...
public class MenuKStreamBuilder {
	...
	@Autowired
	MenuKStreamBuilder(StreamsBuilder streamBuilder, JavaMailSender mailSender, MailBuilder mailBuilder,
