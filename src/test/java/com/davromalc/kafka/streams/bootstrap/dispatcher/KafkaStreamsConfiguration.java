package com.davromalc.kafka.streams.bootstrap.dispatcher;
...
import com.davromalc.kafka.streams.core.kafka.dispatcher.DispatcherKStreamBuilder;
import com.davromalc.kafka.streams.core.kafka.dispatcher.DispatcherKStreamBuilderTest;
...
public class KafkaStreamsConfiguration {
	...
	@Bean
	public DispatcherKStreamBuilder streamBuilder(StreamsBuilder streamBuilder, JavaMailSender mailSender) {
		return new DispatcherKStreamBuilder(streamBuilder, DispatcherKStreamBuilderTest.TOPIC,
				DispatcherKStreamBuilderTest.SYMBOL_TOPIC_MAP);
	}
	...
	Consumer<String, String> consumerTopic() {
		...
		consumer.subscribe(Collections.singletonList(DispatcherKStreamBuilderTest.TOPIC));
		return consumer;
	}
	...
	Consumer<String, String> consumerCustomerTopic1() {
		...
		final Consumer<String, String> consumer = new KafkaConsumer<>(props);
		// Subscribe to the topic.
		consumer.subscribe(Collections.singletonList(DispatcherKStreamBuilderTest.TOPIC_CUSTOMER1));
		return consumer;
	}
	...
	Consumer<String, String> consumerCustomerTopic2() {
		...
		final Consumer<String, String> consumer = new KafkaConsumer<>(props);
		// Subscribe to the topic.
		consumer.subscribe(Collections.singletonList(DispatcherKStreamBuilderTest.TOPIC_CUSTOMER2));
		return consumer;
	}
	...
	Consumer<String, String> consumerCustomerTopic3() {
		...
		final Consumer<String, String> consumer = new KafkaConsumer<>(props);
		// Subscribe to the topic.
		consumer.subscribe(Collections.singletonList(DispatcherKStreamBuilderTest.TOPIC_CUSTOMER3));
		return consumer;
	}
	...
	Consumer<String, String> consumerCustomerTopic4() {
		...
		final Consumer<String, String> consumer = new KafkaConsumer<>(props);
		// Subscribe to the topic.
		consumer.subscribe(Collections.singletonList(DispatcherKStreamBuilderTest.TOPIC_CUSTOMER4));
		return consumer;
	}
	...
	Consumer<String, String> consumerCustomerTopic5() {
		...
		final Consumer<String, String> consumer = new KafkaConsumer<>(props);
		// Subscribe to the topic.
		consumer.subscribe(Collections.singletonList(DispatcherKStreamBuilderTest.TOPIC_CUSTOMER5));
		return consumer;
	}
