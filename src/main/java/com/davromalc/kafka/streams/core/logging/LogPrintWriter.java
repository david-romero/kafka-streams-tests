package com.davromalc.kafka.streams.core.logging;
...
public class LogPrintWriter extends PrintWriter {
	 ...
	 */
	public LogPrintWriter(String prefix, Writer out) {
		super(out, false);
		this.prefix = prefix;
	}
	 ...
	 *            A character-output stream
	 * @param autoFlush
	 *            A boolean; if true, the println() methods will flush the output
	 *            buffer
	 */
	public LogPrintWriter(String prefix, Writer out, boolean autoFlush) {
		super(out, autoFlush);
		this.prefix = prefix;
	}

	/**
	 * Create a new PrintWriter, without automatic line flushing, from an existing
	 * OutputStream. This convenience constructor creates the necessary intermediate
	 ...
	 */
	public LogPrintWriter(String prefix, OutputStream out) {
		super(out, false);
		this.prefix = prefix;
	}
	 ...
	 * constructor creates the necessary intermediate OutputStreamWriter, which will
	 ...
	 * @see java.io.OutputStreamWriter#OutputStreamWriter(java.io.OutputStream)
	 */
	public LogPrintWriter(String prefix, OutputStream out, boolean autoFlush) {
